...
static const int MAX_TORUS_NUM = 7;
...
static const float BALL_ROTATION_SPEED = 3.0f;
static const float SPEED = 0.1f;
const int SPEED_UP = 1, SPEED_DOWN = -1;

const float PIE = 3.141592;
const float CUBE_RAD = 10.0f;
...
enum { HIDDEN_SURFAE_DELETE_ON, HIDDEN_SURFACE_DELETE_OFF, CULLING_ON, CULLING_OFF,
SHADING_FLAT, SHADING_SMOOTH, FRONT_OPEN, FRONT_CLOSE, TOP_OPEN, TOP_CLOSE};
